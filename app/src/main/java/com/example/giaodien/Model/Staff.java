...
public class Staff {
    ...
    public Staff(int staff_id, String fullname, String sex, String email, String phone, String password) {
        this.staff_id = staff_id;
        this.fullname = fullname;
        this.sex = sex;
        this.email = email;
    ...
    public Staff(String fullname, String sex, String position, String email, String phone, String username, String password) {
        this.fullname = fullname;
        this.sex = sex;
        this.position = position;
        this.email = email;
